...
<div class="card">
    ...
    <div class="card-body">
        <?php
        $action = '';
        $attributes = ['id' => 'editFormSupplier'];
        ?>
        <?= form_open_multipart($action, $attributes) ?>
        <div class="form-group row">
            <label for="idSupplier" class="col-sm-2 col-form-label">Id Penyuplai</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="idSupplier" name="idSupplier" value="<?= $idSupplier ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="nameSupplier" class="col-sm-2 col-form-label">Nama Penyuplai</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="nameSupplier" name="nameSupplier" value="<?= $nameSupplier ?>" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="addressSupplier" name="addressSupplier" value="<?= $addressSupplier ?>">
...
<script>
    $(document).ready(function() {
        $('.save-button').click(function(e) {
            ...
            let form = $('#editFormSupplier')[0];
            let data = new FormData(form);

            $.ajax({
                type: "post",
                url: "<?= site_url('supplier/editSupplier') ?>",
                data: data,
                dataType: "json",
