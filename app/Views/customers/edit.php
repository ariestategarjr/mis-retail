...
<div class="card">
    ...
    <div class="card-body">
        <?php
        $action = '';
        $attributes = ['id' => 'editFormCustomer'];
        ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="nameCustomer" name="nameCustomer" value="<?= $nameCustomer ?>" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="addressCustomer" name="addressCustomer" value="<?= $addressCustomer ?>">
...
<script>
    $(document).ready(function() {
        $('.save-button').click(function(e) {
            ...
            let form = $('#editFormCustomer')[0];
            let data = new FormData(form);

            $.ajax({
                type: "post",
                url: "<?= site_url('customer/editCustomer') ?>",
                data: data,
                dataType: "json",
